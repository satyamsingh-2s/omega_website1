...
export const assetImages: Record<string, Img> = {
  ...
  "ASSET 02": {
    src: "/images/assest_gemini.png",
    alt: "Chart a Path — new workspace creation in Omega",
  },
  "ASSET 03": {
    src: "/images/assest_03.png",
    alt: "Active Flow session timer with intended and invested time",
  },
  "ASSET 04": {
    src: "/images/assest_desk_omega.png",
    alt: "Desk Omega task queue with today and future work",
  },
  "ASSET 05": {
    src: "/images/assest_05.png",
    alt: "Omega revision note preserving context between sessions",
  },
  "ASSET 06": {
    src: "/images/assest_06.png",
    alt: "Footprints — Omega session history and totals",
  },
  ...
  "ASSET HERO": {
    src: launch.url,
    alt: "Omega launch screen: planned work, unplanned work, daily record",
  },
};
